...
final class Version20250317142913 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Matiere_niveau (id INT AUTO_INCREMENT NOT NULL, niveau_id INT NOT NULL, Matiere_id INT NOT NULL, coeficient DOUBLE PRECISION NOT NULL, INDEX IDX_41544B9EB3E9C81 (niveau_id), INDEX IDX_41544B9E695CF4DA (Matiere_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE Matiere_niveau ADD CONSTRAINT FK_41544B9EB3E9C81 FOREIGN KEY (niveau_id) REFERENCES niveau (id)');
        $this->addSql('ALTER TABLE Matiere_niveau ADD CONSTRAINT FK_41544B9E695CF4DA FOREIGN KEY (Matiere_id) REFERENCES Matiere (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Matiere_niveau DROP FOREIGN KEY FK_41544B9EB3E9C81');
        $this->addSql('ALTER TABLE Matiere_niveau DROP FOREIGN KEY FK_41544B9E695CF4DA');
